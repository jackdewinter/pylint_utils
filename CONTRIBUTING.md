...
and bugs in the [project backlog](https://github.com/jackdewinter/pylint_utils/issues)
...
[project backlog](https://github.com/jackdewinter/pylint_utils/issues)
and see if it is there, or if something like it is there.  If it is not there,
please [create an issue](https://github.com/jackdewinter/pylint_utils/issues),
